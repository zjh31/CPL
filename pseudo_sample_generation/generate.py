...
parser.add_argument('--img_root', default='/network_space/storage43/ln_data/images/train2014', type=str)
parser.add_argument('--output_dir', default='output/gref', type=str)
...
parser.add_argument('--object_file', default='pseudo_sample_generation/object_detect/data.pth', type=str)
parser.add_argument('--dataset', default='gref', type=str)
