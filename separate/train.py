...
def get_args_parser():
    ...
    parser.add_argument('--train_ann_file', type=str, default='',
...
def main(args):
    ...
    # build dataset
    dataset_train = build_dataset('train', args.train_ann_file, args)
    dataset_val = build_dataset('val', args.val_ann_file, args)
    if args.distributed:
